...
import {
  create_coin_element_in_popup,
  create_coin_element_in_sidebar,
  homing_cell,
} from "./coin.ts";
...
// Access the first value of knownCells
export let cell_with_popup: Cell = board.knownCells.values().next().value!;
...
function render_sidebar() {
  ...
  for (const coin of inventory.coins) {
    sidebar.appendChild(create_coin_element_in_sidebar(coin));
  }
}
